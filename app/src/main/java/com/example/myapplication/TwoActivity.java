...
public class TwoActivity extends AppCompatActivity {
    ...
    private MaterialButton button0, button1, button2, button3, button4, button5, button6, button7, button8, button9,
            buttonDot, buttonAdd, buttonSub, buttonMultiply, buttonDivide, buttonPercent, buttonClear, buttonOFF, buttonEqual , bsin, bcos,btan,blog,bln,bfact,bsqrt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bsin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "sin");
            }
        });
        bcos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "cos");
            }
        });
        btan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "tan");
            }
        });
        blog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "log");
            }
        });
        bln.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "ln");
            }
        });
        bfact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "fact");
            }
        });
        bsqrt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputDisplay.setText(inputDisplay.getText() + "sqrt");
            }
        });
        ...
        bsqrt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (allCalculations.text.toString().isEmpty()) {
         ...
         bfact.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public  void  parseExpression(): Double {
                    var x = parseTerm()
                    while (true) {
                ...
                @Override
                public static void  parseTerm(): Double {
                    var x = parseFactor()
                    while (true) {
